...
highlight normal font='Fixed Semi-Condensed 10' ctermfg=black guifg=black guibg=white
...
highlight Special term=NONE cterm=NONE gui=NONE ctermfg=darkgreen guifg=#00C000
...
highlight statement term=bold cterm=bold gui=bold ctermfg=darkcyan guifg=#00C0C0
highlight preproc term=bold cterm=bold gui=bold ctermfg=blue guifg=#0000FF
highlight constant term=NONE cterm=NONE gui=NONE ctermfg=darkmagenta guifg=#C000C0
highlight link number constant
highlight type term=bold cterm=bold gui=bold ctermfg=brown guifg=#808000
highlight identifier term=NONE cterm=NONE gui=NONE ctermfg=darkmagenta guifg=#C000C0
